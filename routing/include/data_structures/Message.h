...
struct Message
{
    ...
    Message(const NodeInfo &node_info, MessageType message_type, const boost::uuids::uuid request_id);
    virtual ~Message();
};
...
struct PingRequestMessage : public Message
{
    ...
    PingRequestMessage(const NodeInfo &node_info, const boost::uuids::uuid request_id);
};
...
struct StoreRequestMessage : public Message
{
    ...
    StoreRequestMessage(const NodeInfo &node_info, const boost::uuids::uuid request_id, const UserInfo &user_info);
};
...
struct FindNodeRequestMessage : public Message
{
    ...
    FindNodeRequestMessage(const NodeInfo &node_info, const boost::uuids::uuid request_id, const boost::uuids::uuid guid);
};

struct FindDataRequestMessage : public Message
{
    boost::uuids::uuid guid;
    FindDataRequestMessage(const NodeInfo &node_info, const boost::uuids::uuid guid);
    FindDataRequestMessage(const NodeInfo &node_info, const boost::uuids::uuid request_id, const boost::uuids::uuid guid);
};

struct PingResponseMessage : public Message
{
    PingResponseMessage(const NodeInfo &node_info, const boost::uuids::uuid request_id);
};

struct StoreResponseMessage : public Message
{
    StoreResponseMessage(const NodeInfo &node_info, const boost::uuids::uuid request_id);
};

struct FindNodeResponseMessage : public Message
{
    std::list<NodeInfo> nodes_info;
    FindNodeResponseMessage(const NodeInfo &node_info, const boost::uuids::uuid request_id, const std::list<NodeInfo> &nodes_info);
};
...
struct FindDataResponseMessage : public Message
{
    UserInfo user_info;
    std::list<NodeInfo> nodes_info;
    FindDataResponseMessage(const NodeInfo &node_info, const boost::uuids::uuid request_id, const UserInfo &user_info, const std::list<NodeInfo> &nodes_info);
};
